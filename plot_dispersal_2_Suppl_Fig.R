...
break()		
#	pdf("venn_day1.pdf",useDingbats=FALSE)	
	graph.D1=venn(list(ASV.T1D1, ASV.T2D1, ASV.Bee), zcolor="style", snames=c("T1","T2","Bee"))
	attr.D1<-attr(graph.D1,"intersection")
#	dev.off()
	
#	pdf("venn_day3.pdf",useDingbats=FALSE)
	graph.D3=venn(list(ASV.T1D3, ASV.T2D3, ASV.Bee), zcolor="style", snames=c("T1","T2","Bee"))
	attr.D3<-attr(graph.D3,"intersection")
#	dev.off()

#	pdf("venn_day5.pdf",useDingbats=FALSE)	
	graph.D5=venn(list(ASV.T1D5, ASV.T2D5, ASV.Bee), zcolor="style", snames=c("T1","T2","Bee"))
	attr.D5<-attr(graph.D5,"intersection")
#	dev.off()
...
#	pdf("venn_bacteria.pdf",useDingbats=FALSE)
	graph.all=venn(list(ASV.T1,ASV.T2,ASV.Bee),  zcolor="style", snames=c("T1","T2","Bee"))
